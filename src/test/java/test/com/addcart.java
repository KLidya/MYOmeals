...
public class addcart {
  ...
  public void test() throws Exception {
    ...
    driver.findElement(By.xpath("//div[@id='page']/div/section/div/div[2]/div/section/div/div/div/div[2]/div/div/a/span/span")).click();
    driver.findElement(By.id("menu-wc-categories-select")).click();
    new Select(driver.findElement(By.id("menu-wc-categories-select"))).selectByVisibleText("Lunch Items");
